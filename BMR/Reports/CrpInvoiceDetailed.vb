...
Public Class CrpInvoiceDetailed
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BMR.CrpInvoiceDetailed.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpInvoiceDetailed
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpInvoiceDetailed = New CrpInvoiceDetailed
        rpt.Site = Me.Site
        Return rpt
    End Function
