        ...
        Try
            ...
            For i As Integer = 0 To Val(txtcarton_wg.Text) - 1
                ...
                Dim query As String = "insert into barcode(Carton_Serial_no,Product_code,Product_type,Pur_date,sort_code,pur_loc" & _
                             ...
                             "" & CType(cmbsorttype.SelectedItem, itemdata).Value & "," & Loc_Code & ",'" & txtbatch_no.Text & "'," & _
                             "" & Loc_Code & "," & User_Code & "," & txtpack_size.Text & "," & txtcarton_weight.Text & ",0,'" & txtsap_code.Text & "','" & FullBatch & "')"
